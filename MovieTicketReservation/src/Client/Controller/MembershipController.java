...
public class MembershipController {
	...
	public class MemBackSelected implements ActionListener {
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			selectGUI.getMemPassField().setText("");
			selectGUI.getMemEmailField().setText("");
	...
	public class MemPaySubmit implements ActionListener {
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			if(modelCtrl.payMembership(credentials)) {
				selectGUI.getMemSuccess().setText("SUCCESSFULLY RENEW");
			}
			else {
				selectGUI.getMemSuccess().setText("RENEWAL FAILED");
			}
			selectGUI.getMemSuccess().setVisible(true);
